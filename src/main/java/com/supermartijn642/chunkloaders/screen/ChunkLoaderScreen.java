...
public class ChunkLoaderScreen extends BaseWidget {
    ...
    public void renderBackground(int mouseX, int mouseY){
        ...
        int usernameWidth = username == null ? 0 : ClientUtils.getFontRenderer().width(TextComponents.string(username).color(TextFormatting.WHITE).format());
        int ownerHintWidth = ClientUtils.getFontRenderer().width(TextComponents.translation("chunkloaders.gui.owner").format());
        int loadedChunksHintWidth = ClientUtils.getFontRenderer().width(TextComponents.translation("chunkloaders.gui.loaded_chunks").format());
