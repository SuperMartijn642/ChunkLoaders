...
public class ServerChunkLoadingCapability extends ChunkLoadingCapability {
    ...
    private void loadChunk(ChunkPos pos){
        ForgeChunkManager.forceChunk((ServerWorld)this.level, "chunkloaders", CHUNK_LOADER_GLOBAL_UUID, pos.x, pos.z, true, true);
    }

    private void unloadChunk(ChunkPos pos){
        ForgeChunkManager.forceChunk((ServerWorld)this.level, "chunkloaders", CHUNK_LOADER_GLOBAL_UUID, pos.x, pos.z, false, true);
    }
